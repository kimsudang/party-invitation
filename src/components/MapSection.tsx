...
const MapSection = () => {
    return (
        <section className="px-6 py-10">
            <h2 className="pb-6 text-center text-2xl font-bold text-invitation-title">오시는 길</h2>
            ...
            <div className="text-center space-y-1">
                <p className="text-base font-medium text-invitation-text">서울특별시 광진구 능동로 90 더 클래식 500</p>
                <p className="text-base text-muted-fg">02-2218-5000</p>
            </div>
        </section>
    );
};
