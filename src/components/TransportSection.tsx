...
const TransportSection = () => {
    return (
        <section className="px-6 pb-10">
            <h3 className="pb-6 text-center text-2lg font-semibold text-invitation-title">대중교통</h3>
            ...
            <div className="mb-6">
                ...
                <div className="space-y-2 text-sm text-invitation-text">
            ...
            <div>
                <div className="mb-3 flex items-center justify-start gap-2 text-muted-fg">
                    ...
                    <span className="text-sm font-medium">버스</span>
                </div>
                <div className="space-y-1.5 text-sm text-invitation-text">
                    <div className="flex gap-4">
                        <span className="w-16 shrink-0 font-medium text-muted-fg">간선버스</span>
                        <span>102, 240, 721</span>
                    </div>
                    <div className="flex gap-4">
                        <span className="w-16 shrink-0 font-medium text-muted-fg">지선버스</span>
                        <span>2222, 2224, 2016, 3217, 3220, 4212, 2412, 2014</span>
                    </div>
                    <div className="flex gap-4">
                        <span className="w-16 shrink-0 font-medium text-muted-fg">마을버스</span>
                        <span>광진 05</span>
                    </div>
                </div>
            </div>
